...
**未知人物只写证据，不写身份。** 当章节指导要求暂不确认某个人物、书写者、跟踪者或对手身份时，禁止直接以“她/他”代替该未知者，也禁止补造其外貌、动机、职业、身体参数或当前视角无法测得的精度。只能写主角此刻能够看见、听见、触到、闻到、或由已出现物件复核的动作和痕迹，例如袖口落下的碎屑、纸条递来的方向、指尖留下的热痕。`;
}
